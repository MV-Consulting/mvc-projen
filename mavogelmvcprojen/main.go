...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MvcCdkConstructLibrary)(nil)).Elem(),
		[]_jsii_.Member{
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.Type__awscdkAwsCdkConstructLibrary)
			return &j
		},
	)
	_jsii_.RegisterStruct(
		"@mavogel/mvc-projen.MvcCdkConstructLibraryOptions",
		reflect.TypeOf((*MvcCdkConstructLibraryOptions)(nil)).Elem(),
	)
}
